...
#define TMC5XXX_MOTOR_ADDR(m)     (0x20 << (m))
#define TMC5XXX_MOTOR_ADDR_DRV(m) ((m) << 4)

#define TMC5XXX_RAMPMODE(motor)   (0x00 | TMC5XXX_MOTOR_ADDR(motor))
#define TMC5XXX_XACTUAL(motor)    (0x01 | TMC5XXX_MOTOR_ADDR(motor))
#define TMC5XXX_VACTUAL(motor)    (0x02 | TMC5XXX_MOTOR_ADDR(motor))
#define TMC5XXX_VSTART(motor)     (0x03 | TMC5XXX_MOTOR_ADDR(motor))
#define TMC5XXX_A1(motor)         (0x04 | TMC5XXX_MOTOR_ADDR(motor))
#define TMC5XXX_V1(motor)         (0x05 | TMC5XXX_MOTOR_ADDR(motor))
#define TMC5XXX_AMAX(motor)       (0x06 | TMC5XXX_MOTOR_ADDR(motor))
#define TMC5XXX_VMAX(motor)       (0x07 | TMC5XXX_MOTOR_ADDR(motor))
#define TMC5XXX_DMAX(motor)       (0x08 | TMC5XXX_MOTOR_ADDR(motor))
#define TMC5XXX_D1(motor)         (0x0A | TMC5XXX_MOTOR_ADDR(motor))
#define TMC5XXX_VSTOP(motor)      (0x0B | TMC5XXX_MOTOR_ADDR(motor))
#define TMC5XXX_TZEROWAIT(motor)  (0x0C | TMC5XXX_MOTOR_ADDR(motor))
#define TMC5XXX_XTARGET(motor)    (0x0D | TMC5XXX_MOTOR_ADDR(motor))
#define TMC5XXX_SWMODE(motor)     (0x14 | TMC5XXX_MOTOR_ADDR(motor))
#define TMC5XXX_RAMPSTAT(motor)   (0x15 | TMC5XXX_MOTOR_ADDR(motor))
#define TMC5XXX_CHOPCONF(motor)   (0x6C | TMC5XXX_MOTOR_ADDR_DRV(motor))
#define TMC5XXX_COOLCONF(motor)   (0x6D | TMC5XXX_MOTOR_ADDR_DRV(motor))
#define TMC5XXX_DRVSTATUS(motor)  (0x6F | TMC5XXX_MOTOR_ADDR_DRV(motor))
...
#define TMC50XX_IHOLD_IRUN(motor) (0x10 | TMC5XXX_MOTOR_ADDR(motor))
#define TMC50XX_VCOOLTHRS(motor)  (0x11 | TMC5XXX_MOTOR_ADDR(motor))
#define TMC50XX_VHIGH(motor)      (0x12 | TMC5XXX_MOTOR_ADDR(motor))
#define TMC50XX_XLATCH(motor)     (0x16 | TMC5XXX_MOTOR_ADDR(motor))

#define TMC50XX_MSLUT0(motor)     (0x60 | TMC5XXX_MOTOR_ADDR_DRV(motor))
#define TMC50XX_MSLUT1(motor)     (0x61 | TMC5XXX_MOTOR_ADDR_DRV(motor))
#define TMC50XX_MSLUT2(motor)     (0x62 | TMC5XXX_MOTOR_ADDR_DRV(motor))
#define TMC50XX_MSLUT3(motor)     (0x63 | TMC5XXX_MOTOR_ADDR_DRV(motor))
#define TMC50XX_MSLUT4(motor)     (0x64 | TMC5XXX_MOTOR_ADDR_DRV(motor))
#define TMC50XX_MSLUT5(motor)     (0x65 | TMC5XXX_MOTOR_ADDR_DRV(motor))
#define TMC50XX_MSLUT6(motor)     (0x66 | TMC5XXX_MOTOR_ADDR_DRV(motor))
#define TMC50XX_MSLUT7(motor)     (0x67 | TMC5XXX_MOTOR_ADDR_DRV(motor))
#define TMC50XX_MSLUTSEL(motor)   (0x68 | TMC5XXX_MOTOR_ADDR_DRV(motor))
#define TMC50XX_MSLUTSTART(motor) (0x69 | TMC5XXX_MOTOR_ADDR_DRV(motor))
#define TMC50XX_MSCNT(motor)      (0x6A | TMC5XXX_MOTOR_ADDR_DRV(motor))
#define TMC50XX_MSCURACT(motor)   (0x6B | TMC5XXX_MOTOR_ADDR_DRV(motor))
...
// TMC5160 specific registers locations
